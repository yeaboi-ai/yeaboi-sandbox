# Agent instructions — yeaboi-sandbox
...
- Sandbox tests must stay hermetic. Live vendor operations are outside the test/ship gate; never destroy the shared sbx-1 environment without explicit approval.
